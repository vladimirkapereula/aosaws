...
def check_out_shopping_cart():
    ...
    if driver.current_url == 'https://advantageonlineshopping.com/#/login':
        ...
        if driver.current_url == 'https://advantageonlineshopping.com/#/orderPayment':
            ...
            print(f' Username for Payments for this Order is: {locators.new_username}')
...
def contact_us_form():
    ...
    if driver.find_element(By.XPATH, '//*[@id = "supportCover"]/div[2]/h1').is_displayed():
        ...
        sleep(2)
        driver.find_element(By.XPATH, '//select[@name="productListboxContactUs"]').send_keys('HP Pro Tablet 608 G1')
        sleep(2)
